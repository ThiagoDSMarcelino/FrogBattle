...
pygame.mixer.music.load("assets/audio/soundtrack.wav")
...
#load heart images
heart_empty = scale_img(pygame.image.load("assets/images/items/heart_empty.png").convert_alpha(), constants.ITEM_SCALE * 0.5)
heart_half = scale_img(pygame.image.load("assets/images/items/heart_half.png").convert_alpha(), constants.ITEM_SCALE * 0.5)
heart_full = scale_img(pygame.image.load("assets/images/items/heart_full.png").convert_alpha(), constants.ITEM_SCALE * 0.5)
...
mob_animations = []
mob_types = ["frogsoldier", "imp", "skeleton", "goblin", "muddy", "tiny_zombie", "big_demon"]
